...
module IDM.Scripts.angular2 {
    ...
    export class IDM_TRANSACCIONES_TIPOS_DTO {
        
        // TIPO_TRANSACCION_ID
        public tipO_TRANSACCION_ID: number = 0;
        // DESC_TIPO_TRANSACCION
        public desC_TIPO_TRANSACCION: string = null;
        // SIGLAS_TIPO_TRANSACCION
        public siglaS_TIPO_TRANSACCION: string = null;
        // FECHA_ELABORACION
