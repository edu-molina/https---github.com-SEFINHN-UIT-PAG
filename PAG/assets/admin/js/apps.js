    ...
    return {
        ...
        handleBaseURL: function () {
            var getUrl = window.location,
                baseUrl = getUrl.protocol + "//" + getUrl.host + "/";//+ getUrl.pathname.split('/')[1];// Path modified jframirez
            return baseUrl;
        },
        ...
        handleSidebarResponsive: function () {
            ...
            //DISABLE UNABLE FOR THEME DEMO CHANGE
            /*
        ...
        handleBoxModal: function () {
            ...
            //    var form = $('<div class="">                        <div class="panel rounded shadow">                            <div class="panel-body">                                <div class="inner-all">                                    <ul class="list-unstyled">                                        <li class="text-center">                                            <img class="img-circle img-bordered-primary" src="http://img.djavaui.com/?create=100x100,4888E1?f=ffffff" alt="Tol Lee">                                        </li>                                        <li class="text-center">                                            <h4 class="text-capitalize">Tol Lee</h4>                                            <p class="text-muted text-capitalize">web designer</p>                                        </li>                                                                                <li><br/></li>                                        <li>                                            <div class="btn-group-vertical btn-block">                                                                                                <a href="" class="btn btn-default"><i class="fa fa-sign-out pull-right"></i>Cerrar sesion</a>                                            </div>                                        </li>                                    </ul>                                </div>                            </div>                        </div><!-- /.panel -->                        <div class="panel panel-theme rounded shadow">                            <div class="panel-heading">                                <div class="pull-left">                                    <h3 class="panel-title">Contacto</h3>                                </div>                                                                <div class="clearfix"></div>                            </div><!-- /.panel-heading -->                            <div class="panel-body no-padding rounded">                                <ul class="list-group no-margin">                                    <li class="list-group-item"><i class="fa fa-envelope mr-5"></i> support@djavaui.com</li>                                    <li class="list-group-item"><i class="fa fa-globe mr-5"></i> www.djavaui.com</li>                                    <li class="list-group-item"><i class="fa fa-phone mr-5"></i> +6281 903 xxx xxx</li><li class="list-group-item"><i class="fa fa-phone mr-5"></i> +6281 903 xxx xxx</li><li class="list-group-item"><i class="fa fa-phone mr-5"></i> +6281 903 xxx xxx</li><li class="list-group-item"><i class="fa fa-phone mr-5"></i> +6281 903 xxx xxx</li>                                </ul>                            </div><!-- /.panel-body -->                        </div><!-- /.panel -->                    </div>');
            //    bootbox.dialog({
            //        message: form,
            //        title: 'Configuracion',
            ...
            $('#lock-screen').on('click', function(){
                ...
                ion.sound.play('camera_flashing');
                bootbox.dialog({
                    message: 'Cerrar sesion y regresar a la pantalla de inicio?',
                    title: 'Bloquear ventana',
                    className: 'modal-primary modal-center',
                    buttons: {
                        danger: {
                            label: 'No',
