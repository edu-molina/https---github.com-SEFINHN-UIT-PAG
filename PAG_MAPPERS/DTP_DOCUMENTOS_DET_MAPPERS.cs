...
namespace PAG_MAPPERS
{
    ...
    public static class DTP_DOCUMENTOS_DET_MAPPERS
    {
        
        public static DTP_DOCUMENTOS_DET_DTO ToDto(this DTP_DOCUMENTOS_DET entity)
        {
            DTP_DOCUMENTOS_DET_DTO dto = new DTP_DOCUMENTOS_DET_DTO();
        ...
        public static DTP_DOCUMENTOS_DET ToEntity(this DTP_DOCUMENTOS_DET_DTO dto)
        {
