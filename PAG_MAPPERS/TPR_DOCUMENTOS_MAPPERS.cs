...
namespace PAG_MAPPERS
{
    ...
    public static class TPR_DOCUMENTOS_MAPPERS
    {
        
        public static TPR_DOCUMENTOS_DTO ToDto(this TPR_DOCUMENTOS entity)
        {
            TPR_DOCUMENTOS_DTO dto = new TPR_DOCUMENTOS_DTO();
        ...
        public static TPR_DOCUMENTOS ToEntity(this TPR_DOCUMENTOS_DTO dto)
        {
